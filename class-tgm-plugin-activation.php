...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Installa Plugin Richiesto', 'tgmpa' ),
				'menu_title'                      => __( 'Installa Plugins', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'installing'                      => __( 'Installazione Plugin: %s', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'updating'                        => __( 'Aggiorna Plugin: %s', 'tgmpa' ),
				'oops'                            => __( 'Something went wrong with the plugin API.', 'tgmpa' ),
				'notice_can_install_required'     => _n_noop(
					/* translators: 1: plugin name(s). */
					'Questo Plugin richiede questo componente: %1$s.',
					'Questo Plugin richiede questi compenti: %1$s.',
					'tgmpa'
				),
				...
				'dismiss'                         => __( 'Rimuovi Notifica', 'tgmpa' ),
